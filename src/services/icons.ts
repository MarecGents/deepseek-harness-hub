...
export const DESKTOP_ICON_ASSETS: Readonly<Record<string, string>> = {
  'whale-girl-sad': '../../assets/icons/whale-girl-sad.png',
  'whale-girl-happy': '../../assets/icons/whale-girl-happy.png',
  'whale-girl-duo': '../../assets/icons/whale-girl-duo.png',
  'whale-girl-maid': '../../assets/icons/whale-girl-maid.png',
  'whale-girl-blue': '../../assets/icons/whale-girl-blue.png',
}
 ...
 */
export function isKnownDesktopIcon(id: string): boolean {
  return id === DEFAULT_DESKTOP_ICON_ID || id in DESKTOP_ICON_ASSETS
}
 ...
 */
export function loadDesktopIcon(id: string): Icon | undefined {
  const asset = DESKTOP_ICON_ASSETS[id]
  return asset === undefined ? undefined : loadPngRgba(asset)
}
