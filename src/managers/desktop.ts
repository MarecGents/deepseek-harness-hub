...
import { JsonWindowStateStore, MIN_HEIGHT, MIN_WIDTH } from '../helpers/state-store.js'
import { setTitleBarDark, setTitleBarDarkPowerShell } from '../helpers/dwm-theme.js'
import { osThemeIsLight, refreshOsTheme } from '../helpers/os-theme.js'
import { resolveLaunchScreen } from '../helpers/screen.js'
import { WebViewThemeDetector } from '../services/theme-sync.js'
import { WebViewTray, type TrayCommand } from './tray.js'
import { dshFaviconBlack, dshFaviconDark, dshFaviconDataUrl, dshFaviconTray } from '../helpers/icons.js'
import { playTaskSound, type TaskSoundKind } from '../helpers/sound.js'
