...
export function applyBackground(backgroundId: string): void {
  ...
  style.textContent = `#root > div > div[style*="grid-template-columns"]{` +
    ...
    `#root > div > div[style*="grid-template-columns"] > div:first-child{` +
    `background-color:transparent !important;` +
    `}` +
    `#root > div > div[style*="grid-template-columns"] [data-slot="sidebar"] > div{` +
    ...
    `#root > div > div[style*="grid-template-columns"] [data-slot="conversation"] > div{` +
    ...
    `#root > div > div[style*="grid-template-columns"] [data-slot="conversation"] [data-conversation-composer-overlay]{` +
    `background-color:color-mix(in srgb, var(--dsw-alias-bg-base) 75%, transparent) !important;` +
    `}` +
    ...
    `#root > div > div[style*="grid-template-columns"] [data-slot="details"] > div{` +
