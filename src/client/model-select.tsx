...
const CSS = [
  ...
  '[data-phase="active"] [data-composer-seat]:has(._dshnms_menu){z-index:60 !important}',
  '[data-phase="hero"] [data-composer-seat]:has(._dshnms_menu){position:relative;z-index:60 !important}',
