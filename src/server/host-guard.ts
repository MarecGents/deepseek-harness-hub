 ...
 */
export function rejectIfBadHost(req: IncomingMessage, res: ServerResponse): boolean {
 ...
 * @returns true when the request was rejected (caller must stop handling).
 */
export function rejectIfBadOrigin(req: IncomingMessage, res: ServerResponse): boolean {
