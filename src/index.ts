...
import { openDesktopShell, type DesktopShellHandle } from './managers/desktop.ts'
...
import { makeConfigRoutes, hasStoredWindowSize, migrateLegacyPaths, readShellConfig, storedNotifyOnTaskComplete, storedSoundEnabled, type ShellConfig } from './server/config-api.js'
