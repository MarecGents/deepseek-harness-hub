...
export declare const MG_TRAY_PREFIX = "MG_TRAY ";
/** host→壳 上行帧前缀（stdout，node.rs dispatch_dsh_cmd 解析）。 */
export declare const DSH_CMD_PREFIX = "DSH_CMD ";
 ...
 */
export type DshCmdName = 'set_window_theme' | 'set_window_size' | 'set_desktop_icon' | 'notify_task_complete' | 'play_sound' | 'open_workspace_path' | 'dispatch_page_event';
