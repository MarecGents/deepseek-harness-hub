		...
		*/
		...
		function RightSidebar({ openDetails, closeDetails, useProjection, useSessions, useWorkspaces }) {
			...
			(0, react.useEffect)(() => {
				...
				Promise.all([fetchDir(workspacePath), fetchGit(workspacePath)]).then(([rows, info]) => {
					if (!alive) return;
					setRootEntries(rows);
					setGit(info);
						...
						children: [
							...
							tab === "files" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									...
									children: "工作区文件"
								}), workspacePath === "" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									...
									className: RIGHT_SIDEBAR_CSS_CLASSES.statValue,
									children: stats?.decodeTokens !== void 0 ? formatTokens(stats.decodeTokens) : "-"
								})]
							})
						]
					})]
		...
		function GitTab({ git, loading }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: git.changes.map((change, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
