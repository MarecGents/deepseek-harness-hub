...
const TAB_ACTIVE = {
    ...TAB,
    // Active tab: the official interactive-hover tint over the titlebar, PLUS
    // the brand underline. In the DEFAULT skin + light mode bg-layer-1 ==
    // bg-layer-3 (both white), so a layer-3 lift disappears entirely — the
    // interactive tint stays visible in every skin/theme (2026-09-01 audit).
    background: 'color-mix(in srgb, var(--dsw-alias-interactive-bg-hover, rgba(128,128,128,.16)) 70%, transparent)',
