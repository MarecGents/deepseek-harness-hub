...
import { setFontSize, setShell, toggleTheme, usePrefs } from "./terminal-prefs.js";
...
const DOCK = {
    ...
    boxShadow: 'var(--dsw-shadow-lv2, 0 -10px 40px rgb(0 0 0 / 35%))', boxSizing: 'border-box', overflow: 'hidden',
};
const TABBAR = {
...
const SETTINGS = {
    ...
    borderRadius: 10, padding: '10px 12px', boxShadow: 'var(--dsw-shadow-lv2, 0 8px 24px rgb(0 0 0 / 40%))',
...
export function TerminalPage() {
    ...
    useEffect(() => {
        ...
        const apply = () => {
            ...
            if (target !== null)
                target.style.marginBottom = visible ? (height + 6) + 'px' : '';
        };
        apply();
