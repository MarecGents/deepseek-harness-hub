...
import { injectCardStyle, injectChatVisibilityStyle } from "./style.js";
...
import { installWorkspaceDragGuard } from "./workspace-drag-guard.js";
import { installConversationRail, refreshConversationRailPalette } from "./conversation-rail.js";
import { installModelSelect } from "./model-select.js";
import { PermissionPolicyChip } from "./permission-policy-chip.js";
import { SessionTabs } from "./SessionTabs.js";
import { bindPtyRuntime, fetchShells, ptyToggle } from "./pty-store.js";
import { syncHostPrefs } from "./terminal-prefs.js";
...
export function apply(ctx) {
    ...
    const onTerminalKey = (event) => {
        ...
        if (target?.closest('[data-dsh-hub-terminal]') !== null)
            return;
        ...
        ctx.effect(() => {
            ...
            const onContext = (event) => {
                ...
                if (target instanceof Element) {
                    ...
                    if (target.closest('div[role="treeitem"]'))
                        return;
