...
import { PERMISSION_POLICIES, permissionPolicyLabel, fetchPolicy, savePolicy } from "./permission-policy-chip.js";
import { refreshConversationRailPalette } from "./conversation-rail.js";
import { DESKTOP_ICONS, DEFAULT_DESKTOP_ICON_ID } from "./desktop-icons.js";
...
function SkinDot({ skin }) {
    if (skin === undefined) {
        return (_jsx("span", { className: c.swatchDot, style: { background: 'var(--dsw-alias-bg-module-platform, #f5f6f7)' }, "aria-hidden": "true" }));
    }
    return (_jsx("span", { className: c.swatchDot, style: { background: `linear-gradient(90deg, ${skin.light['bg-base']} 0 50%, ${skin.dark['bg-base']} 50% 100%)` }, "aria-hidden": "true" }));
}
...
export function DesktopSettingsCard(_props) {
    ...
    const [desktopIconId, setDesktopIconId] = useState(DEFAULT_DESKTOP_ICON_ID);
    ...
    const COPY = {
        ...
        themeOptions: { system: t('settings.themeSystem'), light: t('settings.themeLight'), dark: t('settings.themeDark') },
    ...
    const skinName = (id) => t(`skin.name.${id}`) ?? SKINS.find((s) => s.id === id)?.name ?? id;
    /** Dictionary key for a skin's description (falls back to the static copy). */
    const skinDesc = (id) => t(`skin.desc.${id}`) ?? SKINS.find((s) => s.id === id)?.description ?? id;
    ...
    const onPickPermissionPolicy = (id) => {
        if (id === permissionPolicy)
            return;
        const previous = permissionPolicy;
        setPermissionPolicyFailed(false);
        setPermissionPolicy(id);
    ...
    return (_jsxs("li", { className: clsx(c.card, open && c.cardOpen), children: [_jsxs("button", { type: "button", className: c.header, "aria-expanded": open, "aria-label": `${open ? '收起' : '展开'}: ${COPY.title}`, onClick: () => { setOpen(!open); }, children: [_jsxs("span", { className: c.headText, children: [_jsx("span", { className: c.name, children: COPY.title }), _jsx("span", { className: c.description, children: COPY.description })] }), dirty ? _jsx("span", { className: c.pending, children: COPY.unsaved }) : null, _jsx(IconChevronDownOutline14, { className: clsx(c.chevron, open && c.chevronOpen) })] }), open
                ? (_jsxs("div", { className: c.body, children: [loading
                            ...
                            : (_jsxs(_Fragment, { children: [draft !== null && (_jsxs("div", { className: c.group, children: [_jsxs("button", { type: "button", className: c.groupTitle, "aria-expanded": groupOpen.resolution, onClick: () => setGroupOpen((g) => ({ ...g, resolution: !g.resolution })), children: [_jsx("span", { children: COPY.resolutionSection }), _jsx(IconChevronDownOutline14, { className: clsx(c.chevron, groupOpen.resolution && c.chevronOpen) })] }), groupOpen.resolution && (_jsxs("div", { className: c.section, children: [_jsxs("div", { className: c.field, children: [_jsx("span", { className: c.fieldLabel, children: COPY.widthLabel }), _jsx("input", { className: c.input, type: "number", min: 480, max: Math.floor(window.screen.width), "aria-label": COPY.widthLabel, value: draft.width, onChange: (event) => {
                                                                ...
                                                                } })] })] }))] })), draft !== null && (_jsxs("div", { className: c.group, children: [_jsxs("button", { type: "button", className: c.groupTitle, "aria-expanded": groupOpen.general, onClick: () => setGroupOpen((g) => ({ ...g, general: !g.general })), children: [_jsx("span", { children: COPY.generalSection }), _jsx(IconChevronDownOutline14, { className: clsx(c.chevron, groupOpen.general && c.chevronOpen) })] }), groupOpen.general && (_jsxs("div", { className: c.section, children: [_jsxs("label", { className: c.checkboxRow, children: [_jsx("input", { type: "checkbox", checked: draft.minimizeToTray, onChange: (event) => patchDraft({ minimizeToTray: event.target.checked }) }), _jsx("span", { children: COPY.minimizeLabel })] }), _jsx("div", { className: c.hint, children: COPY.minimizeHint }), _jsxs("label", { className: c.checkboxRow, children: [_jsx("input", { type: "checkbox", checked: draft.closeToTray, onChange: (event) => patchDraft({ closeToTray: event.target.checked }) }), _jsx("span", { children: COPY.closeLabel })] }), _jsx("div", { className: c.hint, children: COPY.closeHint }), _jsxs("label", { className: c.checkboxRow, children: [_jsx("input", { type: "checkbox", checked: draft.notifyOnTaskComplete, onChange: (event) => patchDraft({ notifyOnTaskComplete: event.target.checked }) }), _jsx("span", { children: COPY.notifyLabel })] }), _jsx("div", { className: c.hint, children: COPY.notifyHint }), _jsxs("label", { className: c.checkboxRow, children: [_jsx("input", { type: "checkbox", checked: draft.soundEnabled, onChange: (event) => patchDraft({ soundEnabled: event.target.checked }) }), _jsx("span", { children: COPY.soundLabel })] }), _jsx("div", { className: c.hint, children: COPY.soundHint }), _jsxs("label", { className: c.checkboxRow, children: [_jsx("input", { type: "checkbox", checked: draft.allowMultipleInstances, onChange: (event) => patchDraft({ allowMultipleInstances: event.target.checked }) }), _jsx("span", { children: COPY.multiInstanceLabel })] }), draft.allowMultipleInstances
                                                        ? _jsx("div", { className: c.dangerHint, role: "alert", children: COPY.multiInstanceDanger })
                                                        : _jsx("div", { className: c.hint, children: COPY.multiInstanceHint })] }))] })), draft !== null && (_jsxs("div", { className: c.group, children: [_jsxs("button", { type: "button", className: c.groupTitle, "aria-expanded": groupOpen.appearance, onClick: () => setGroupOpen((g) => ({ ...g, appearance: !g.appearance })), children: [_jsx("span", { children: COPY.appearanceSection }), _jsx(IconChevronDownOutline14, { className: clsx(c.chevron, groupOpen.appearance && c.chevronOpen) })] }), groupOpen.appearance && (_jsxs("div", { className: c.section, children: [_jsxs("div", { className: c.field, children: [_jsx("span", { className: c.fieldLabel, children: COPY.themeLabel }), _jsxs("select", { className: c.select, "aria-label": COPY.themeLabel, value: draft.theme, onChange: (event) => {
                                                                    const theme = event.target.value;
                                                                    if (theme === 'system' || theme === 'light' || theme === 'dark')
                                                                        patchDraft({ theme });
                                                                }, children: [_jsx("option", { value: "system", children: COPY.themeOptions.system }), _jsx("option", { value: "light", children: COPY.themeOptions.light }), _jsx("option", { value: "dark", children: COPY.themeOptions.dark })] }), _jsx("div", { className: c.hint, children: COPY.themeHint })] }), _jsxs("div", { className: c.fieldRow, children: [_jsx("span", { className: c.fieldLabel, children: t('settings.skinLabel') }), _jsx(Menu, { open: skinMenuOpen, onClose: () => { setSkinMenuOpen(false); }, items: [
                                                                    { id: DEFAULT_SKIN_ID, label: t('settings.skinDefaultName'), icon: _jsx(SkinDot, { skin: undefined }) },
                                                                    ...SKINS.map((skin) => ({ id: skin.id, label: skinName(skin.id), icon: _jsx(SkinDot, { skin: skin }) })),
                                                                ], selectedId: skinId, onSelect: (id) => {
                                                                    onPickSkin(id);
                                                                    setSkinMenuOpen(false);
                                                                }, align: "end", portal: true, anchor: (_jsxs("button", { type: "button", className: c.selectPill, "aria-haspopup": "menu", "aria-expanded": skinMenuOpen, onClick: () => { setSkinMenuOpen(v => !v); }, children: [_jsx(SkinDot, { skin: SKINS.find((skin) => skin.id === skinId) }), skinId === DEFAULT_SKIN_ID
                                                                            ? t('settings.skinDefaultName')
                                                                            : skinName(skinId), _jsx(IconChevronDownOutline14, {})] })) })] }), _jsxs("div", { className: c.hint, children: [skinId === DEFAULT_SKIN_ID
                                                                ? t('settings.skinDefaultDesc')
                                                                : skinDesc(skinId), ' — ', t('settings.skinHint')] }), skinFailed ? _jsx("p", { className: c.failed, role: "status", children: t('settings.skinApplyFailed') }) : null, _jsx("div", { className: c.sectionTitle, children: COPY.backgroundSection }), _jsxs("div", { className: c.fieldRow, children: [_jsx("span", { className: c.fieldLabel, children: COPY.backgroundLabel }), _jsx(Menu, { open: backgroundMenuOpen, onClose: () => { setBackgroundMenuOpen(false); }, items: [
                                                                ...
                                                                : (BACKGROUNDS.find((background) => background.id === backgroundId)?.description ?? ''), ' — ', COPY.backgroundHint] }), backgroundFailed ? _jsx("p", { className: c.failed, role: "status", children: COPY.backgroundApplyFailed }) : null, _jsx("div", { className: c.sectionTitle, children: COPY.desktopIconSection }), _jsx("div", { className: c.hint, children: COPY.desktopIconHint }), _jsx("div", { className: c.iconGrid, role: "radiogroup", "aria-label": COPY.desktopIconSection, children: DESKTOP_ICONS.map((icon) => (_jsxs("button", { type: "button", role: "radio", "aria-checked": desktopIconId === icon.id, className: clsx(c.iconCell, desktopIconId === icon.id && c.iconSelected), onClick: () => { onPickDesktopIcon(icon.id); }, title: `${icon.name} — ${icon.description}`, children: [_jsx("img", { className: c.iconPreview, src: icon.url, alt: icon.name, width: 56, height: 56, draggable: false }), _jsx("span", { className: c.iconName, children: icon.name })] }, icon.id))) }), desktopIconFailed ? _jsx("p", { className: c.failed, role: "status", children: COPY.desktopIconApplyFailed }) : null] }))] })), permissionPolicy !== null && (_jsxs("div", { className: c.section, children: [_jsxs("div", { className: c.fieldRow, children: [_jsx("span", { className: c.fieldLabel, children: t('settings.permissionLabel') }), _jsx(Menu, { open: permissionPolicyMenuOpen, onClose: () => { setPermissionPolicyMenuOpen(false); }, items: PERMISSION_POLICIES.map((id) => ({ id, label: permissionPolicyLabel(id) })), selectedId: permissionPolicy, onSelect: (id) => {
                                                            onPickPermissionPolicy(id);
                                                            setPermissionPolicyMenuOpen(false);
                                                        }, align: "end", portal: true, anchor: (_jsxs("button", { type: "button", className: c.selectPill, "aria-haspopup": "menu", "aria-expanded": permissionPolicyMenuOpen, onClick: () => { setPermissionPolicyMenuOpen((v) => !v); }, children: [permissionPolicyLabel(permissionPolicy), _jsx(IconChevronDownOutline14, {})] })) })] }), _jsx("div", { className: c.hint, children: t('settings.permissionHint') }), permissionPolicyFailed ? _jsx("p", { className: c.failed, role: "status", children: t('settings.permissionApplyFailed') }) : null] }))] })), _jsxs("div", { className: c.footer, children: [failed ? _jsx("p", { className: c.failed, role: "status", children: COPY.saveFailed }) : null, saved ? _jsx("p", { className: c.saved, role: "status", children: COPY.saved }) : null, _jsx("button", { type: "button", className: c.discard, disabled: blocked, onClick: onDiscard, children: COPY.discard }), _jsx("button", { type: "button", className: c.save, disabled: blocked, onClick: onSave, children: COPY[saving ? 'saving' : 'save'] })] })] }))
                : null] }));
}
