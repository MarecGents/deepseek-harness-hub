...
function SkinSwatch({ skin }) {
    ...
    return (_jsxs("span", { className: c.skinSwatch, "aria-hidden": "true", children: [_jsxs("span", { className: c.swatchHalf, style: half('light'), children: [_jsx("span", { className: c.swatchDot, style: { background: skin.light['label-primary'] } }), _jsx("span", { className: c.swatchBar, style: { background: skin.light['brand-primary'] } })] }), _jsxs("span", { className: c.swatchHalf, style: half('dark'), children: [_jsx("span", { className: c.swatchDot, style: { background: skin.dark['label-primary'] } }), _jsx("span", { className: c.swatchBar, style: { background: skin.dark['brand-primary'] } })] })] }));
}
    ...
    return (_jsxs("li", { className: clsx(c.card, open && c.cardOpen), children: [_jsxs("button", { type: "button", className: c.header, "aria-expanded": open, "aria-label": `${open ? '收起' : '展开'}: ${COPY.title}`, onClick: () => { setOpen(!open); }, children: [_jsxs("span", { className: c.headText, children: [_jsx("span", { className: c.name, children: COPY.title }), _jsx("span", { className: c.description, children: COPY.description })] }), dirty ? _jsx("span", { className: c.pending, children: COPY.unsaved }) : null, _jsx(IconChevronDownOutline14, { className: clsx(c.chevron, open && c.chevronOpen) })] }), open
                ? (_jsxs("div", { className: c.body, children: [loading
                            ...
                            : (_jsxs(_Fragment, { children: [draft !== null && (_jsxs("div", { className: c.section, children: [_jsx("div", { className: c.sectionTitle, children: COPY.windowSection }), _jsxs("div", { className: c.field, children: [_jsx("span", { className: c.fieldLabel, children: COPY.widthLabel }), _jsx("input", { className: c.input, type: "number", min: 480, max: Math.floor(window.screen.width), "aria-label": COPY.widthLabel, value: draft.width, onChange: (event) => {
                                                ...
                                                : _jsx("div", { className: c.hint, children: COPY.multiInstanceHint })] })), draft !== null && (_jsxs("div", { className: c.section, children: [_jsx("div", { className: c.sectionTitle, children: COPY.skinSection }), _jsxs("div", { className: c.skinGrid, role: "radiogroup", "aria-label": COPY.skinLabel, children: [_jsxs("button", { type: "button", role: "radio", "aria-checked": skinId === DEFAULT_SKIN_ID, className: clsx(c.iconCell, skinId === DEFAULT_SKIN_ID && c.iconSelected), onClick: () => { onPickSkin(DEFAULT_SKIN_ID); }, title: COPY.skinDefaultDesc, children: [_jsx("span", { className: clsx(c.skinSwatch, c.skinSwatchDefault) }), _jsx("span", { className: c.iconName, children: COPY.skinDefaultName })] }, DEFAULT_SKIN_ID), skinGroupsOf(SKINS).map((group) => (_jsxs(Fragment, { children: [_jsx("div", { className: c.skinGroup, children: group.label }), group.skins.map((skin) => (_jsxs("button", { type: "button", role: "radio", "aria-checked": skinId === skin.id, className: clsx(c.iconCell, skinId === skin.id && c.iconSelected), onClick: () => { onPickSkin(skin.id); }, title: skin.description, children: [_jsx(SkinSwatch, { skin: skin }), _jsx("span", { className: c.iconName, children: skin.name })] }, skin.id)))] }, group.label)))] }), _jsxs("div", { className: c.hint, children: [skinId === DEFAULT_SKIN_ID
