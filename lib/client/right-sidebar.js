...
export function RightSidebar({ openDetails, closeDetails, useProjection, useSessions, useWorkspaces, useSession, sessionId }) {
    ...
    const turnOrder = useSession((s) => s?.chat?.timeline?.turnOrder ?? []);
    ...
    useEffect(() => {
        if (collapsed)
            document.body.setAttribute('data-mg-details-collapsed', '');
        else
            document.body.removeAttribute('data-mg-details-collapsed');
...
function Overview(props) {
    ...
    return (_jsxs("div", { children: [_jsxs("div", { className: c.section, children: [_jsx("div", { className: c.sectionTitle, children: "\u603B\u4E0A\u4E0B\u6587 TOKEN" }), totalTokens === undefined
                        ? _jsx("div", { className: c.empty, children: "\u6682\u65E0 Token \u6570\u636E" })
                        : (_jsxs("div", { className: c.chartWrap, children: [_jsx("div", { className: c.chart, style: chartGradient ? { background: chartGradient } : undefined, children: _jsx("div", { className: c.chartCenter, children: _jsxs("div", { children: [_jsx("div", { children: formatTokens(totalTokens) }), _jsx("div", { children: "Tokens" })] }) }) }), _jsxs("div", { className: c.legend, children: [_jsxs("div", { className: c.legendRow, children: [_jsx("i", { className: c.legendDot, style: { background: '#3964fe' } }), "\u603B\u8F93\u5165 ", formatTokens(totalInputTokens ?? 0)] }), _jsxs("div", { className: c.legendRow, children: [_jsx("i", { className: c.legendDot, style: { background: '#16a34a' } }), "\u603B\u8F93\u51FA ", formatTokens(totalOutputTokens ?? 0)] })] })] })), _jsxs("div", { className: c.statGrid, children: [_jsxs("div", { className: c.stat, children: [_jsx("div", { className: c.statLabel, children: "\u8F6E\u6B21 / \u6B65\u6570" }), _jsxs("div", { className: c.statValue, children: [stats?.turns ?? '-', " \u8F6E \u00B7 ", stats?.steps ?? '-', " \u6B65"] })] }), _jsxs("div", { className: c.stat, children: [_jsx("div", { className: c.statLabel, children: "LLM \u8017\u65F6" }), _jsx("div", { className: c.statValue, children: stats?.llmMs !== undefined ? formatDuration(stats.llmMs) : '-' })] }), _jsxs("div", { className: c.stat, children: [_jsx("div", { className: c.statLabel, children: "\u5DE5\u5177\u8C03\u7528" }), _jsx("div", { className: c.statValue, children: stats?.toolMs !== undefined ? formatDuration(stats.toolMs) : '-' })] }), _jsxs("div", { className: c.stat, children: [_jsx("div", { className: c.statLabel, children: "\u9996 token \u5E73\u5747" }), _jsx("div", { className: c.statValue, children: ttftAvg !== undefined ? formatDuration(ttftAvg) : '-' })] }), _jsxs("div", { className: c.stat, children: [_jsx("div", { className: c.statLabel, children: "\u901F\u5EA6" }), _jsx("div", { className: c.statValue, children: tps !== undefined ? `${formatTokensPerSecond(tps)} tok/s` : '-' })] }), _jsxs("div", { className: c.stat, children: [_jsx("div", { className: c.statLabel, children: "\u7F13\u5B58\u547D\u4E2D" }), _jsx("div", { className: c.statValue, children: cacheHit !== undefined && cacheHit !== null ? `${cacheHit}%` : '-' })] }), _jsxs("div", { className: c.stat, children: [_jsx("div", { className: c.statLabel, children: "\u8F93\u5165 Tokens" }), _jsx("div", { className: c.statValue, children: inputTokens !== undefined ? `${formatTokens(inputTokens)} tok` : '-' })] }), _jsxs("div", { className: c.stat, children: [_jsx("div", { className: c.statLabel, children: "\u8F93\u51FA Tokens" }), _jsx("div", { className: c.statValue, children: outputTokens !== undefined ? `${formatTokens(outputTokens)} tok` : '-' })] })] })] }), _jsxs("div", { className: c.section, children: [_jsx("div", { className: c.sectionTitle, children: "\u672C\u8F6E\u5BF9\u8BDD Token" }), turnTokens === undefined
                        ? _jsx("div", { className: c.empty, children: "\u6682\u65E0\u672C\u8F6E\u6570\u636E" })
                        : (_jsxs("div", { className: c.statGrid, children: [_jsxs("div", { className: c.stat, children: [_jsx("div", { className: c.statLabel, children: "\u672C\u8F6E\u8F93\u5165" }), _jsxs("div", { className: c.statValue, children: [formatTokens(billedInputTokens(turnTokens)), " tok"] })] }), _jsxs("div", { className: c.stat, children: [_jsx("div", { className: c.statLabel, children: "\u672C\u8F6E\u8F93\u51FA" }), _jsxs("div", { className: c.statValue, children: [formatTokens(turnTokens.outputTokens), " tok"] })] }), _jsxs("div", { className: c.stat, children: [_jsx("div", { className: c.statLabel, children: "\u672C\u8F6E\u7F13\u5B58\u547D\u4E2D" }), _jsx("div", { className: c.statValue, children: turnCacheHit !== undefined && turnCacheHit !== null ? `${turnCacheHit}%` : '-' })] }), _jsxs("div", { className: c.stat, children: [_jsx("div", { className: c.statLabel, children: "\u672C\u8F6E\u603B\u8BA1" }), _jsx("div", { className: c.statValue, children: turnTotal !== undefined ? `${formatTokens(turnTotal)} tok` : '-' })] })] }))] }), _jsxs("div", { className: c.section, children: [_jsx("div", { className: c.sectionTitle, children: "\u5DE5\u4F5C\u533A" }), loading ? _jsx("div", { className: c.empty, children: "\u52A0\u8F7D\u4E2D\u2026" }) : (_jsxs("div", { className: c.statGrid, children: [_jsxs("div", { className: c.stat, children: [_jsx("div", { className: c.statLabel, children: "\u6587\u4EF6" }), _jsx("div", { className: c.statValue, children: fileCount })] }), _jsxs("div", { className: c.stat, children: [_jsx("div", { className: c.statLabel, children: "\u6587\u4EF6\u5939" }), _jsx("div", { className: c.statValue, children: dirCount })] }), _jsxs("div", { className: c.stat, children: [_jsx("div", { className: c.statLabel, children: "Git" }), _jsx("div", { className: c.statValue, children: git?.isGit ? (git.branch || '仓库') : '非 Git' })] }), _jsxs("div", { className: c.stat, children: [_jsx("div", { className: c.statLabel, children: "\u53D8\u66F4" }), _jsx("div", { className: c.statValue, children: git?.changes.length ?? 0 })] })] }))] })] }));
}
