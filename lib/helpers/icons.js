 ...
 * path.join output must never be fed to it). From both `src/helpers/` and
 * the compiled `lib/helpers/` the package-root `assets/` sits two levels up.
 */
...
export function dshFaviconDark() {
    // src/helpers/ and lib/helpers/ are both two levels below the package
