...
const zhDict = { 'ui.title': t('ui.title'), 'ui.prices': t('ui.prices'), 'ui.pricePerM': t('ui.pricePerM'), 'ui.refresh': t('ui.refresh'), 'ui.savePrices': t('ui.savePrices'), 'ui.saving': t('ui.saving'), 'ui.savedRefreshing': t('ui.savedRefreshing'), 'ui.saveFailed': t('ui.saveFailed'), 'ui.refreshing': t('ui.refreshing'), 'ui.loading': t('ui.loading'), 'ui.readFailed': t('ui.readFailed'), 'ui.empty': t('ui.empty'), 'ui.rate': t('ui.rate'), 'ui.rateLive': t('ui.rateLive'), 'ui.ratePlaceholder': t('ui.ratePlaceholder'), 'ui.headModel': '模型', 'ui.headInput': '输入', 'ui.headOutput': '输出', 'ui.headCacheRead': '缓存读', 'ui.date': t('ui.date'), 'ui.reqCount': t('ui.reqCount'), 'ui.req': t('ui.req'), 'ui.total': '合计', 'bucket.cacheRead': '输入命中缓存', 'bucket.input': '输入未命中缓存', 'bucket.output': '输出', 'bucket.cacheWrite': '缓存写', 'filter.label': t('filter.label'), 'filter.allProviders': t('filter.allProviders'), 'filter.allModels': t('filter.allModels'), 'filter.chooseProvider': t('filter.chooseProvider'), 'filter.allTime': t('filter.allTime'), 'filter.last7d': t('filter.last7d'), 'filter.last30d': t('filter.last30d'), 'filter.reset': '重置', 'pin.pinned': '已置顶', 'pin.pin': '置顶', 'pin.collapse': t('pin.collapse'), 'pin.expand': t('pin.expand'), 'p.unknown': t('p.unknown'), 'ui.estCost': t('ui.estCost'), 'ui.perModel': t('ui.perModel'), 'ui.byDay': t('ui.byDay'), 'ui.cost': t('ui.cost'), 'ui.cacheMissNote': t('ui.cacheMissNote'), 'ui.noMatch': t('ui.noMatch'), 'ui.noData': t('ui.noData'), 'ui.bucketTotal': t('ui.bucketTotal'), 'sum.usage': t('sum.usage'), 'sum.total': t('sum.total'), 'sum.sessions': t('sum.sessions'), 'sum.last7d': t('sum.last7d'), 'sum.last30d': t('sum.last30d'), 'pin.unpin': '取消置顶' };
